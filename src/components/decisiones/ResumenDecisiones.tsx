...
// Fase 6 del sistema de gestión de Comisiones (19/09) — mismo componente
// que ResumenSolicitudes.tsx/ResumenCompras.tsx, en su propia carpeta por
// módulo (mismo criterio ya usado en el resto del proyecto: una copia por
// módulo, no un import compartido).
...
export function ResumenDecisiones({ tiles, columnas = 4 }: { tiles: ResumenTileDef[]; columnas?: 3 | 4 | 5 }) {
