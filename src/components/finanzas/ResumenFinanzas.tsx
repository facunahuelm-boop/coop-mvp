...
/**
 * Rediseño de Finanzas (pedido explícito, 18/09: "quiero que hagas lo mismo
 * con la parte de finanzas" — mismo pedido ya aplicado a Compras/Proveedores/
 * Contactos/Núcleos). Mismo componente que ResumenCompras.tsx, sólo que vive
 * en su propia carpeta por módulo (mismo criterio ya usado para Compras):
 * cada tile de resumen es un cuadrado chico que, al tocarlo, abre un modal
 * con el detalle real detrás del número, en vez de ser sólo un StatTile
 * estático. Sin datos nuevos: `items` ya viene armado desde el Server
 * Component que arma cada pestaña de /finanzas.
 */
