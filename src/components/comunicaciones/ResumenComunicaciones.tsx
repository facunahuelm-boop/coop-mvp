...
// Fase 7 del sistema de gestión de Comisiones (19/09) — mismo componente que
// ResumenDecisiones.tsx/ResumenSolicitudes.tsx, copia por módulo (mismo
// criterio ya usado en el resto del proyecto: una copia por módulo, no un
// import compartido).
...
export function ResumenComunicaciones({ tiles, columnas = 4 }: { tiles: ResumenTileDef[]; columnas?: 3 | 4 | 5 }) {
