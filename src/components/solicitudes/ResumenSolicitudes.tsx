...
// Fase 3 del sistema de gestión de Comisiones (19/09) — mismo componente
// que ResumenCompras.tsx/ResumenFinanzas.tsx, en su propia carpeta por
// módulo (mismo criterio ya usado en el resto del proyecto).
...
export function ResumenSolicitudes({ tiles, columnas = 4 }: { tiles: ResumenTileDef[]; columnas?: 3 | 4 | 5 }) {
